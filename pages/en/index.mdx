...
Mina is the first cryptocurrency protocol with a succinct blockchain. Current cryptocurrencies like Bitcoin and Ethereum store hundreds of gigabytes of data, and as time goes on, their blockchains will only increase in size. With Mina however, no matter how much the usage grows, the blockchain always stays the same size - about 22kb <Footnote refNumber="[1]" link="https://minaprotocol.com/blog/22kb-sized-blockchain-a-technical-reference" /> (the size of a few tweets). This means participants can quickly sync and verify the network.
...
If you're ready to install Mina and begin running a node, head over to the [Getting Started page](/docs/getting-started).
